...
let
  g = config._global;
  resurrectDirPath = "${g.xdg.dataHome}/tmux/resurrect";
...
in
{
  programs.tmux.extraConfig =
    ...
    ''
      ...
      # ============================================= #
      source ${g.xdg.configHome}/tmux/variables.conf
      source ${g.xdg.configHome}/tmux/hooks.conf
      source ${g.xdg.configHome}/tmux/beforePlugins.conf
      ...
      # ============================================= #
      source ${g.xdg.configHome}/tmux/afterPlugins.conf
      source ${g.xdg.configHome}/tmux/binds.conf
    '';
}
