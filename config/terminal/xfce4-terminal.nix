...
in
{
  ...
  xdg.configFile."xfce4/xfconf/xfce-perchannel-xml/xfce4-terminal.xml".text = ''
    ...
    <channel name="xfce4-terminal" version="1.0">
      ...
      <property name="font-name" type="string" value="${f.name} ${builtins.toString f.size}"/>
      ...
      <property name="cell-height-scale" type="double" value="1.5000000000000004"/>
      <property name="background-mode" type="string" value="TERMINAL_BACKGROUND_TRANSPARENT"/>
      <property name="background-darkness" type="double" value="${
        builtins.toString (1 - t.opacity * 100)
      }"/>
