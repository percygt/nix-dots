...
in
{
  programs.tmux.extraConfig =
    ...
    ''
      ...
      run-shell ${pkg.tmuxPlugins.resurrect}/share/tmux-plugins/resurrect/resurrect.tmux
      ...
      run-shell ${pkg.tmuxPlugins.tmuxinoicer}/share/tmux-plugins/tmuxinoicer/tmuxinoicer.tmux
      ...
      run-shell ${pkg.tmuxPlugins.tmux-floax}/share/tmux-plugins/tmux-floax/floax.tmux

      # ---------------------
      # tmuxplugin-vim-tmux-navigator
      # ---------------------
      run-shell ${pkg.tmuxPlugins.vim-tmux-navigator}/share/tmux-plugins/vim-tmux-navigator/vim-tmux-navigator.tmux
      ...
      run-shell ${pkg.tmuxPlugins.extrakto}/share/tmux-plugins/extrakto/extrakto.tmux
      ...
      run-shell ${pkg.tmuxPlugins.continuum}/share/tmux-plugins/continuum/continuum.tmux
