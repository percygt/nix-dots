  ...
  config = lib.mkIf cfg.enable {
    ...
    xdg = {
      configFile = {
        ...
        "doom/early-init.el".source =
          config.lib.file.mkOutOfStoreSymlink "${moduleEmacs}/doom/early-init.el";
        ...
        "doom/lisps".source = config.lib.file.mkOutOfStoreSymlink "${moduleEmacs}/doom/lisps";
