...
}:
{
  options.modules = {
    ...
    btrfs.enable = lib.mkEnableOption "Enable btrfs autoscrub";
    intel.enable = lib.mkEnableOption "Enable intel";
    ...
    nvidia = {
      ...
      bye = lib.mkOption {
        ...
        default = !config.modules.nvidia.prime.enable;
        type = lib.types.bool;
      };
    };
    ...
    udisk2.enable = lib.mkEnableOption "Enable udisk2";
    udiskie.enable = lib.mkOption {
      type = lib.types.bool;
      default = config.modules.udisk2.enable && (desktop != null);
